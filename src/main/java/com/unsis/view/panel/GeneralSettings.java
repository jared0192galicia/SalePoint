...
public class GeneralSettings extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(labelfilter1, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 550, 140, 39));
        ...
        jPanel1.add(buttonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 700, 260, 50));
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 150, 250, 35));
        ...
        jPanel1.add(labelfilter3, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 100, 130, 39));

        jTextField3.setBackground(new java.awt.Color(255, 255, 255));
        jTextField3.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(51, 51, 51));
        jTextField3.setText("2");
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 270, 250, 35));
        ...
        jPanel1.add(labelfilter4, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 220, 130, 39));
        ...
        jPanel1.add(labelfilter5, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 350, 290, 39));
        ...
        jPanel1.add(labelfilter6, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 440, 140, 39));

        jTextField4.setBackground(new java.awt.Color(255, 255, 255));
        jTextField4.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        jTextField4.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 480, 250, 35));

        jTextField5.setBackground(new java.awt.Color(255, 255, 255));
        jTextField5.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        jTextField5.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 590, 250, 35));
        ...
        jPanel1.add(buttonImport, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 710, 260, 50));
